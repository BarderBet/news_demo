...
import 'package:news_demo/pages/main/ad_widget.dart';
import 'package:news_demo/pages/main/categories_widget.dart';
import 'package:news_demo/pages/main/channels_widget.dart';
import 'package:news_demo/pages/main/news_item_widget.dart';
import 'package:news_demo/pages/main/newsletter_widget.dart';
import 'package:news_demo/pages/main/recommend_widget.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  Widget _buildNewsList() {
    return _newsPageList == null ||
            _newsPageList!.items == null ||
            _newsPageList!.items!.isEmpty
        ? Container(
