  ...
  ErrorEntity createErrorEntity(DioException error) {
    switch (error.type) {
      case DioExceptionType.cancel:
        return ErrorEntity(code: DEFAULT_ERROR_CODE, message: "请求取消");
      case DioExceptionType.connectionTimeout:
        return ErrorEntity(code: DEFAULT_ERROR_CODE, message: "连接超时");
      case DioExceptionType.sendTimeout:
        return ErrorEntity(code: DEFAULT_ERROR_CODE, message: "请求超时");
      case DioExceptionType.receiveTimeout:
        return ErrorEntity(code: DEFAULT_ERROR_CODE, message: "响应超时");
      case DioExceptionType.badResponse:
        {
          try {
            if (error.response == null) {
              return ErrorEntity(
                  code: DEFAULT_ERROR_CODE, message: DEFAULT_ERROR_MESSAGE);
            }
            int errCode = error.response!.statusCode ?? -DEFAULT_ERROR_CODE;
            switch (errCode) {
              case 400:
              ...
              default:
                return ErrorEntity(
                    code: errCode,
                    message:
                        error.response!.statusMessage ?? DEFAULT_ERROR_MESSAGE);
            }
...
class ErrorEntity implements Exception {
  ...
  ErrorEntity(
      {this.code = DEFAULT_ERROR_CODE, this.message = DEFAULT_ERROR_MESSAGE});
